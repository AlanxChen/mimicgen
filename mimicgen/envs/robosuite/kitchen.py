...
class Kitchen_D0(KitchenEnv, SingleArmEnv_MG):
    ...
    def __init__(self, **kwargs):
        ...
        self.stove_has_turned_on_when_obj_in_pot = False
    ...
    def _check_success(self):
        ...
        if object_in_pot and not stove_turned_off:
            self.stove_has_turned_on_when_obj_in_pot = True
        return pot_in_serving_region and stove_turned_off and object_in_pot and self.has_stove_turned_on_with_pot_and_object and self.stove_has_turned_on_when_obj_in_pot
...
class Kitchen_T0(Kitchen_D0):
    ...
    def visualize(self, vis_settings):
        ...
        Update site visualization to make sure stove object site visualization is kept up to date.
        """
        super(Kitchen_T0, self).visualize(vis_settings)
        self._post_process()
